...
module.exports = async (req, res) => {
  ...
  try {
    ...
    const updatedWeight = await weightDB.updateWeight(client, postId, weightUuid);

    res.status(statusCode.OK).send(util.success(statusCode.OK, responseMessage.UPDATE_ONE_WEIGHT_SUCCESS, updatedWeight));
  } catch (error) {
